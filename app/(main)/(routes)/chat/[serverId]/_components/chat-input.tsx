            ...
            <FormItem>
              <FormControl>
                <div className="relative p-4 pb-4">
                  ...
                  <Input
                    disabled={isLoading}
                    className="px-14 py-6 bg-neutral-100 dark:bg-neutral-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-neutral-600 dark:text-neutral-200"
                    placeholder={`Message ${
